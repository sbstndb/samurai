#!/usr/bin/env python3
"""
Finite Volume example for the Burgers equation in 2D.
...
- Multiple initial conditions (hat, bands)
- Real-time matplotlib visualization

The Burgers equation: du/dt + div(u ⊗ u) = 0
where u = (u, v) is a 2D velocity field.

Usage:
    python burgers.py                    # Run with default parameters
    python burgers.py --init bands       # Use bands initial condition
    python burgers.py --tf 0.5 --cfl 0.5 # Custom time parameters
    python burgers.py --no-plot          # Disable matplotlib visualization

Options:
    --init {hat,bands}   Initial condition (default: hat)
    --tf FLOAT           Final time (default: 1.0)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Burgers equation 2D with AMR and WENO5",
    ...
    print("=" * 70)
    print("Burgers 2D - WENO5 with TVD-RK3")
    print("=" * 70)
