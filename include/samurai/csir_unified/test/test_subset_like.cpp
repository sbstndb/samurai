...
TEST(CSIRSubsetLikeTest, DifferenceWithTranslate1D)
{
    ...
    CSIR_Level_1D exp = make_1d(1, {{10,11}});
...
TEST(CSIRSubsetLikeTest, EmptySetsBehaviour1D)
{
    ...
    CSIR_Level_1D reg = make_1d(3, {{5,10}});
...
{
    CSIR_Level_1D l = make_1d(3, {{0,1},{2,3},{4,5}});
...
{
    CSIR_Level_1D a = make_1d(0, {{0,1}});
    CSIR_Level_1D b = make_1d(10, {{0,1024}});
...
{
    CSIR_Level_1D l = make_1d(3, {{-10,-5},{-2,3},{8,12}});
...
{
    CSIR_Level_1D l = make_1d(1, {{0,16}});
...
{
    CSIR_Level_1D l1 = make_1d(1, {{0,16}}); CSIR_Level_1D l2 = make_1d(1, {});
