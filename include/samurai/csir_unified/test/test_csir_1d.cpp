...
{
    CSIR_Level_1D a        = make_1d(4,
                                     {
                                  {0,  5 },
                                  {10, 15}
    });
    CSIR_Level_1D b        = make_1d(4,
                                     {
                                  {3,  8 },
                                  {12, 20}
    });
...
{
    CSIR_Level_1D a           = make_1d(3,
                                        {
                                  {0,  4 },
                                  {10, 12}
    }); // L3
    auto up                   = project_to_level(a, 5); // ×4
    CSIR_Level_1D expected_up = make_1d(5,
                                        {
                                            {0,  16},
                                            {40, 48}
    });
...
{
    CSIR_Level_1D a = make_1d(2,
                              {
                                  {0, 10}
    });
    CSIR_Level_1D b = make_1d(3,
                              {
                                  {0, 10}
    });
...
{
    CSIR_Level_1D a    = make_1d(1,
                                 {
                                  {0, 4}
    });
    CSIR_Level_1D b    = make_1d(1,
                                 {
                                  {2, 6}
    });
    std::size_t target = 4;
