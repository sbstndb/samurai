...
int main() {
    ...
    std::cout << "Random Set A:" << std::endl; csir::print_level(rA);
    std::cout << "Random Set B:" << std::endl; csir::print_level(rB);
    auto rU = csir::union_(rA, rB);
    auto rI = csir::intersection(rA, rB);
    auto rD = csir::difference(rA, rB);
    std::cout << "Union(A,B):" << std::endl; csir::print_level(rU);
    std::cout << "Intersect(A,B):" << std::endl; csir::print_level(rI);
    std::cout << "Diff(A,B):" << std::endl; csir::print_level(rD);
