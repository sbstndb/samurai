...
class TestBox1D:
    ...
    def test_creation_from_numpy(self):
        ...
        box = sam.geometry.box(min_corner, max_corner)
        assert box.dim == 1
    ...
    def test_is_valid(self):
        ...
        valid_box = sam.geometry.box([0.], [1.])
        assert valid_box.is_valid()

        invalid_box = sam.geometry.box([1.], [0.])
        assert not invalid_box.is_valid()

    def test_intersects(self):
        """Test box intersection check."""
        box_a = sam.geometry.box([0.], [1.])
        box_b = sam.geometry.box([0.5], [1.5])
        box_c = sam.geometry.box([2.], [3.])
    ...
    def test_equality(self):
        ...
        box_a = sam.geometry.box([0.], [1.])
        box_b = sam.geometry.box([0.], [1.])
        box_c = sam.geometry.box([0.], [2.])
...
class TestBox2D:
    ...
    def test_is_valid(self):
        """Test box validity check."""
        valid_box = sam.geometry.box([0., 0.], [1., 1.])
        assert valid_box.is_valid()

        invalid_box = sam.geometry.box([1., 1.], [0., 0.])
        assert not invalid_box.is_valid()

    def test_intersects(self):
        """Test box intersection check."""
        box_a = sam.geometry.box([0., 0.], [1., 1.])
        box_b = sam.geometry.box([0.5, 0.5], [1.5, 1.5])
        box_c = sam.geometry.box([2., 2.], [3., 3.])
    ...
    def test_equality(self):
        """Test box equality operators."""
        box_a = sam.geometry.box([0., 0.], [1., 1.])
        box_b = sam.geometry.box([0., 0.], [1., 1.])
        box_c = sam.geometry.box([0., 0.], [1., 2.])
...
class TestBox3D:
    ...
    def test_asymmetric_box(self):
        """Test box with different dimensions."""
        box = sam.geometry.box([0., 0., 0.], [2., 1., 0.5])
        length = box.length()
    ...
    def test_is_valid(self):
        """Test box validity check."""
        valid_box = sam.geometry.box([0., 0., 0.], [1., 1., 1.])
        assert valid_box.is_valid()

        invalid_box = sam.geometry.box([1., 1., 1.], [0., 0., 0.])
        assert not invalid_box.is_valid()

    def test_intersects(self):
        """Test box intersection check."""
        box_a = sam.geometry.box([0., 0., 0.], [1., 1., 1.])
        box_b = sam.geometry.box([0.5, 0.5, 0.5], [1.5, 1.5, 1.5])
        box_c = sam.geometry.box([2., 2., 2.], [3., 3., 3.])
...
class TestBoxDifference:
    ...
    def test_difference_non_intersecting(self):
        ...
        box_a = sam.geometry.box([0., 0.], [1., 1.])
        box_b = sam.geometry.box([2., 2.], [3., 3.])
    ...
    def test_difference_intersecting(self):
        ...
        box_a = sam.geometry.box([0., 0.], [2., 2.])
        box_b = sam.geometry.box([1., 1.], [3., 3.])
        result = box_a.difference(box_b)
